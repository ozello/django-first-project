...
ADMINS = (
    ('Alexandre Ozelo', 'ozello@gmail.com'),
)
...
SECRET_KEY = 'rb7r9csy8sg#a-3uarl&2b9rt$rv_w%kle$%n*xdv6h)$u0^=r'
...
EMAIL_HOST_USER = 'ozello@gmail.com'

EMAIL_HOST_PASSWORD = 'aloz010779'

EMAIL_SUBJECT_PREFIX = '[ALOZ]'
